...
import com.raychal.core.databinding.ItemRowDataBinding
import com.raychal.core.domain.model.Movie
import com.raychal.core.utils.DiffUtils
...
class MoviesAdapter : RecyclerView.Adapter<MoviesAdapter.MovieViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieViewHolder {
        ...
        return MovieViewHolder(itemRowDataBinding)
    }
    ...
    inner class MovieViewHolder(private val binding: ItemRowDataBinding) :
